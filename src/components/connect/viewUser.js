...
const ViewUser = ({user, status, sendFriendRequest}) => {
    ...
    return (
        <div className="card">
            ...
            <div className="row">
                ...
                <p className="center">
                    <Link to="#" onClick={() => sendFriendRequest(user.id)}><span style={{paddingRight:'50px'}}><i className="material-icons">group_add</i> {status}</span></Link>
