...
import {createComment} from '../../store/actions/lyricActions'

class AddLyricComment extends React.Component  {
    state = {
        comment: "",
    ...
    handleSubmit = (e) => {
        e.preventDefault()
        let {comment, lyricId} = this.state
...
const mapStateToProps = (state) => {
    return {
        notification: state.lyric.notification
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(AddLyricComment)
