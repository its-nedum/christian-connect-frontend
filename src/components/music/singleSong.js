...
const SingleSong = () => {
    return (
        ...
        <div className="white-text lighten-2" style={{marginTop:'150px', paddingLeft:'10px', backgroundColor:'#000033'}}>
            ...
            <img src='https://res.cloudinary.com/its-nedum/image/upload/v1574430886/lofkg0pzowvvaljislf4.gif' alt="cover" className="responsive-img" style={{width:'400px',height:'300px'}}/>
            </div>
